      ...
      <div className="profile-container">
        ...
        <div className="profile-section">
          ...
          <div className="profile-field">
            ...
            {profile.messenger_url ? (
              <a href={profile.messenger_url} target="_blank" rel="noopener noreferrer">
                {profile.messenger_url}
              </a>
            ) : (
              <span>Not provided</span>
        ...
        <div className="profile-section">
          ...
          <div className="profile-field">
            ...
            <span className={profile.is_verified ? 'badge-verified' : 'badge-unverified'}>
          ...
          {profile.last_daily_checkin && (
            <div className="profile-field">
              ...
              <span>{new Date(profile.last_daily_checkin).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
              })}</span>
