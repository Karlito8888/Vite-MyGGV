...
- **CRITICAL**: ALSO examine `src/contexts`, `src/hooks`, `src/services`, and `src/utils` directories before planning anything to avoid reinventing the wheel or duplicating code!
